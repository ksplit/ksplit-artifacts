...
static int boot_main(void)
{
	...
	m = lvd_create_module_klcd_no_thread(LCD_DIR("msr_autogen/msr_klcd"),
				"lcd_test_mod_msr_autogen_msr_klcd",
				&msr_klcd);
	...
	ret = lvd_create_module_lvd(LCD_DIR("msr_autogen/msr_lcd"),
				"lcd_test_mod_msr_autogen_msr_lcd",
				&msr_lcd,
				&msr_ctx, 1);
	if (ret) {
...
fail4:
	...
	lcd_destroy_module_klcd(msr_klcd, "lcd_test_mod_msr_autogen_msr_klcd");
fail3:
